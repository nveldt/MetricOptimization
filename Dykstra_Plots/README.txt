...
The constraint satisfaction plots all look like step functions. This is because in the algorithm we only perform a full constraint satisfaction check every 10-20 iterations to find the maximum error at that point. Performing a full check every single iteration would be expensive.