...
# for Correlation clustering and LambdaCC. All code is cleaned up and updated
# in order to run extensive experimental evaluations.
#
...
#       statusFrequency = how often to do a full check on constraint violations
#       stagnationTol = if primal and dual change less than stangnationTol,
#                       then we are not making progress quickly enough so we
#                       return early
#
# Outputs:
#
...
function Dykstra_lamCC_TFA(A::SparseMatrixCSC{Float64,Int64},GapTol::Float64=1e-3,ConTol::Float64=1e-3,
