...
@time SerialTripleLoop!(E,D,corrections)
...
println("Total violations found equals $TotalViolations")
...
@time TrueSerialTripleLoop!(E,D,corrections)
TotalViolations = length(corrections)

println("TrueSerial Violations: $TotalViolations")
end
