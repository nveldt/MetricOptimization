...
# lam = .5
# L = Int64(round(lam*1000))
# Dfile = "fileoutput/Dykstra\_Lam$L\_n$n"
# Dfile2 = "fileoutput/Dykstra\_Lam$L\_n$n\_short"
# Bfile = "fileoutput/Bauschke\_Lam$L\_n$n"
# Bfile2 = "fileoutput/Bauschke\_Lam$L\_n$n\_short"
#
#
# W = lam*ones(n,n)
# for i = 1:n-1
...
# E = zeros(n,n)
# F = -gam*ones(n,n)
# tic(); Hout = Bauschke_TF(A,Dgraph,E,F,W,BauschkeTols,TriTol,lam,Bfile2,Bfile,gam,1/gam,vareps,maxits); Bauschke_time = toc()
