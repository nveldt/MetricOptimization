...
function Hildreth_lamCC_TFA(A::SparseMatrixCSC{Float64,Int64},Xtol::Float64,TriTol::Float64,
                ...
                Y::Matrix{Float64},P::Matrix{Float64},Q::Matrix{Float64},D::Matrix{Int8},triplet_corrections::SparseVector{Float64,Int64})
        ...
        triplet_corrections = spzeros(n^3,1)
...
function report_progress(A::SparseMatrixCSC{Float64,Int64},X::Matrix{Float64},triplet_corrections::SparseVector{Float64,Int64},
...
function cyclic_triangle_constraints!(A::SparseMatrixCSC{Float64,Int64},D::Matrix{Int8},X::Matrix{Float64},
    W::Matrix{Float64},triplet_corrections::SparseVector{Float64,Int64},alpha::Float64)
...
function noncyclic_triangle_constraints!(A::SparseMatrixCSC{Float64,Int64},D::Matrix{Int8},X::Matrix{Float64},
    W::Matrix{Float64},triplet_corrections::SparseVector{Float64,Int64},alpha::Float64,numtimes::Int64)
...
function ABCproj!(X::Matrix{Float64},triplet_corrections::SparseVector{Float64,Int64},alpha::Float64,
...
function ABCproj2!(X::Matrix{Float64},triplet_corrections::SparseVector{Float64,Int64},alpha::Float64,
    a::Int64,b::Int64,wab::Float64,wac::Float64,wbc::Float64,n::Int64,denom::Float64,ijkKey::Int64,AC1::Int64,AC2::Int64,BC1::Int64,BC2::Int64)
    ...
    Xbc = X[BC1,BC2]
    # Correction step
    corr = triplet_corrections[ijkKey]
    ...
    if delta > 0
        ...
        triplet_corrections[ijkKey] = 0.0
    end
...
function LongTripleLoop!(triplet_corrections::SparseVector{Float64,Int64},X::Matrix{Float64},W::Matrix{Float64})
  n = size(X,1)
...
function LongTripleLoop3!(triplet_corrections::SparseVector{Float64,Int64},X::Matrix{Float64},W::Matrix{Float64})
  n = size(X,1)
  epsi = 1e-12       # constraint tolerance
...
function LongTripleLoop2!(triplet_corrections::SparseVector{Float64,Int64},X::Matrix{Float64},W::Matrix{Float64})
  n = size(X,1)
  epsi = 1e-12       # constraint tolerance
...
function UncorrectedProjection(X::Matrix{Float64},triplet_corrections::SparseVector{Float64,Int64},alpha::Float64,
    a::Int64,b::Int64,wab::Float64,wac::Float64,wbc::Float64,n::Int64,denom::Float64,ijkKey::Int64,AC1::Int64,AC2::Int64,BC1::Int64,BC2::Int64)
