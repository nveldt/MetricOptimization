...
function Dykstra_lamCC_TFA(A::SparseMatrixCSC{Float64,Int64},tol::Float64=1e-3,TriTol::Float64=1e-3,
        ...
        corrections = Dict{Int64,Float64}()

        # First time through constraints
        cyclic_triple_loop!(D,E,W,corrections)
        ...
        while iter < maxits
                ...
                tricheck, lastTri, objective = report_progress(A,E+D,corrections,filename,vecChange,iter,TriTol,lam,lastTri,TriTime)
...
function report_progress(A::SparseMatrixCSC{Float64,Int64},X::Matrix{Float64},current_corrections::Dict{Int64,Float64},
...
function cyclic_triple_loop!(D::Matrix{Float64},E::Matrix{Float64},W::Matrix{Float64},corrections::Dict{Int64,Float64})
  n = size(D,1)
  epsi = 1e-8
  ...
  @inbounds for i = 1:n-2
    ...
    if haskey(corrections,ijkKey)

      cor = pop!(corrections,ijkKey)
