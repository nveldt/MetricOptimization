...
function Dykstra_LeightonRao_TFA(A::SparseMatrixCSC{Float64,Int64},Xtol::Float64=1e-3,TriTol::Float64=1e-5,
        ...
        while iter < maxits
                ...
                tricheck, lastTri, objective = report_progress(A,X,filename,vecChange,iter,TriTol,lam,lastTri,TriTime)
...
function report_progress(A::SparseMatrixCSC{Float64,Int64},X::Matrix{Float64},
    filename::String,xChange::Float64,iter::Int64,TriTol::Float64,lam::Float64,lastTri::Float64,triTime::Float64)
        ...
        println("Iteration $iter, ||x_k - x_{k+1}|| = $ch, 3Loop = $time, Obj: $ob, Last TriCheck = $tr")
